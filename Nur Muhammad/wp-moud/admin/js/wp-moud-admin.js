...
(function( $ ) {
    ...
    $(function(){
        ...
        var frame,
            ...
            imgPreview = $('#upload_logo_preview'),       //create a variable to store data
            
            
            imgDelButton = $('#wp_moud-delete_logo_button'),
            // Color Pickers Inputs
            colorPickerInputs = $( '.wp-moud-color-picker' );

        // WordPress specific plugins - color picker and image upload
        $( '.wp-moud-color-picker' ).wpColorPicker();
